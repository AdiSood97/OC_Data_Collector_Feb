...
class _ViewList13State extends State<ViewList13> {
  ...
  String tempval = "";
  String lightning_meter_no="",lightning_common_name="",lightning_father_name="",lightning_picture_bell_power='';
  Future getData() async {
    SharedPreferences preferences=await SharedPreferences.getInstance();
    setState(() {
      lightning_picture_bell_power=preferences.getString('lightning_picture_bell_power');
                                        ...
                                        children: [
                                          Row(
                                            textDirection: locator<LanguageService>().currentlanguage == 0
                                                ...
                                                : TextDirection.rtl,
                                            children: <Widget>[
                                              completedcheckbox(isCompleted: (lightning_meter_no?? "") ==''?false:true),
                                             /* Text(
                                                '*',
                                        ...
                                        children: [
                                          Row(
                                            textDirection: locator<LanguageService>().currentlanguage == 0
                                                ...
                                                : TextDirection.rtl,
                                            children: <Widget>[
                                              completedcheckbox(isCompleted: (lightning_common_name?? "") ==''?false:true),
                                              /*Text(
                                                '*',
                                                style: TextStyle(color: Colors.red, fontSize: 18),
                                              ),*/
                                        ...
                                        children: [
                                          Row(
                                            textDirection: locator<LanguageService>().currentlanguage == 0
                                                ...
                                                : TextDirection.rtl,
                                            children: <Widget>[
                                              completedcheckbox(isCompleted: (lightning_father_name?? "") ==''?false:true),
                                              /*Text(
                                                '*',
                                                style: TextStyle(color: Colors.red, fontSize: 18),
                                              ),*/
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        Row(
                                          children: <Widget>[
                                            completedcheckbox(
                                                isCompleted: (lightning_picture_bell_power?? "") ==''?false:true),
                                            Flexible(
                                              child: Text(
                                                setapptext(
                                                            ...
                                                            Column(
                                                              ...
                                                              children: <
                                                                ...
                                                                GestureDetector(
                                                                  onTap:
                                                                      () async {
                                                                    lightning_picture_bell_power = await appimagepicker(source: ImageSource.camera);
                                                                ...
                                                                GestureDetector(
                                                                  onTap:
                                                                      () async {
                                                                   lightning_picture_bell_power = await appimagepicker(source: ImageSource.gallery);
                                                                    Navigator.pop(context);
                                                                    setState(() {});
                                                                  },
                                                                  child:
                                          ...
                                          child: Center(
                                            child: Container(
                                              ...
                                              width: MediaQuery.of(context)
                                                  ...
                                                  .width /
                                                  2,
                                              child: lightning_picture_bell_power
                                                  ?.isEmpty ??
                                                  true
                                                  ? Center(
                                                child: Text(setapptext(
                                                  ...
                                                  : File(lightning_picture_bell_power)
                                                  .existsSync()
                                                  ? Image.file(
                                                File(lightning_picture_bell_power),
                                              )
