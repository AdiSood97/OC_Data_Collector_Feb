...
import 'package:kapp/pages/ViewList15.dart';
...
class ViewList14 extends StatefulWidget {
  @override
  _ViewList14State createState() => _ViewList14State();
}

class _ViewList14State extends State<ViewList14> {
                                        ...
                                        children: [
                                          Row(
                                            textDirection: locator<LanguageService>().currentlanguage == 0
                                                ...
                                                : TextDirection.rtl,
                                            children: <Widget>[
                                              completedcheckbox(isCompleted: (safari_booklet_common_name?? "") ==''?false:true),
                                              /*Text(
                                                '*',
                                          ...
                                          Padding(
                                            ...
                                            child: Text(safari_booklet_common_name,style: TextStyle(fontSize: 20,color: Colors.black),),
                                          ),
                                          Padding(
                                        ...
                                        children: [
                                          Row(
                                            textDirection: locator<LanguageService>().currentlanguage == 0
                                                ...
                                                : TextDirection.rtl,
                                            children: <Widget>[
                                              completedcheckbox(isCompleted: (safari_booklet_father_name?? "") ==''?false:true),
                                              /*Text(
                                                '*',
                                                style: TextStyle(color: Colors.red, fontSize: 18),
                                              ),*/
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.only(left: 10),
                                            child: Text(safari_booklet_father_name,style: TextStyle(fontSize: 20,color: Colors.black),),
                                          ),
                                          Padding(
                                            padding: const EdgeInsets.only(left: 10,right: 10,top: 10),
                                            child: Divider(
                                        ...
                                        children: [
                                          Row(
                                            textDirection: locator<LanguageService>().currentlanguage == 0
                                                ...
                                                : TextDirection.rtl,
                                            children: <Widget>[
                                              completedcheckbox(isCompleted: (safari_booklet_machinegun_no?? "") ==''?false:true),
                                              /*Text(
                                                '*',
                                                style: TextStyle(color: Colors.red, fontSize: 18),
                                              ),*/
                                              Flexible(
                                                child: Container(
                                                  child: Text(setapptext(key: 'key_Safari_Machine_Gun_Number'),
                                                    overflow: TextOverflow.visible,
                                                    softWrap: true,
                                                    style: TextStyle(),
                                                    textDirection:
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.only(left: 10),
                                            child: Text(safari_booklet_machinegun_no,style: TextStyle(fontSize: 20,color: Colors.black),),
                                          ),
                                          Padding(
                                            padding: const EdgeInsets.only(left: 10,right: 10,top: 10),
                                            child: Divider(
                                        ...
                                        Row(
                                          children: <Widget>[
                                            ...
                                            Flexible(
                                              child: Text(
                                                setapptext(
                                                    key: 'key_Picture_of_Safari_Booklet'),
                                                style: TextStyle(),
                                              ),
                                            ),
                                          ],
