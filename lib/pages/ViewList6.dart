                                  ...
                                  child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.only(left: 10),
                                            child: Text(doc_reg_number!=null ? doc_reg_number :"",style: TextStyle(fontSize: 20,color: Colors.black),),
                                          ),
                                          Padding(
                                            padding: const EdgeInsets.only(left: 10,right: 10,top: 10),
                                            child: Divider(
                                  ...
                                  child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            padding: const EdgeInsets.only(left: 10),
                                            child: Text(land_area_qawwala!=null ? land_area_qawwala :"",style: TextStyle(fontSize: 20,color: Colors.black),),
                                          ),
                                          Padding(
                                            padding: const EdgeInsets.only(left: 10,right: 10,top: 10),
                                            child: Divider(
