                                      ...
                                      children: [
                                        Row(
                                          textDirection: locator<LanguageService>().currentlanguage == 0
                                              ...
                                              : TextDirection.rtl,
                                          children: <Widget>[
                                            completedcheckbox(isCompleted: issue_regarding_property==''?false:true),
                                            /*Text(
                                              '*',
                                      ...
                                      children: [
                                        Row(
                                          textDirection: locator<LanguageService>().currentlanguage == 0
                                              ...
                                              : TextDirection.rtl,
                                          children: <Widget>[
                                            completedcheckbox(isCompleted: municipality_ref_number==''?false:true),
                                            /*Text(
                                              '*',
                                              style: TextStyle(color: Colors.red, fontSize: 18),
                                            ),*/
